...
class DeeppolyReluNode(DeeppolyNonlinearity):
    def transformer(self, nn, man, element, nlb, nub, relu_groups, refine, timeout_lp, timeout_milp, use_default_heuristic, testing, K=2, s=-1, use_milp=False, approx=True):
        """
        ...
        if refine:
            refine_activation_with_solver_bounds(nn, self, man, element, nlb, nub, relu_groups, timeout_lp,
                                                 timeout_milp, use_default_heuristic, config.domain,
